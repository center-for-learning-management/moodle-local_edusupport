...
$string['issue_assign_3rdlevel:post'] = '<a href="{$a->wwwroot}/profile/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a> hat dieses Ticket an <a href="{$a->wwwroot}/profile/view.php?id={$a->touserid}">{$a->touserfullname}</a> ({$a->tosupportlevel}) weitergeleitet.';
