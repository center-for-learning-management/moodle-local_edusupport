...
$string['header'] = 'Hilfe in {$a} anfordern';
...
$string['screenshot:invalid'] = 'Die hochgeladene Datei ist kein gültiges Bild oder der Inhalt passt nicht zur Dateiendung. Erlaubt sind GIF, JPG, PNG und WEBP.';
