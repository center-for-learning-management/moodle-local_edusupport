...
$string['edusupport:canforward2ndlevel'] = 'Kann Probleme an den 2nd Level Support melden';
...
$string['issue_assign_3rdlevel:post'] = '<a href="{$a->wwwroot}/profile/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a> hat dieses Ticket an <a href="{$a->wwwroot}/profile/view.php?id={$a->touserid}">{$a->touserfullname}</a> weitergeleitet.';
$string['issue_assign_3rdlevel:postself'] = '<a href="{$a->wwwroot}/profile/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a> hat die Verantwortung für dieses Ticket übernommen.';
...
$string['issue_closed:post'] = 'Dieses Ticket wurde von <a href="{$a->wwwroot}/profile/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a> geschlossen. Falls Sie weitere Unterstützung benötigen, fordern Sie bitte wieder den 2nd Level Support an!';
...
$string['no_such_issue'] = 'Dies ist kein offenes Ticket!';
