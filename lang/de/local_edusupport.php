...
$string['issue_closed:post'] = 'Dieses Ticket wurde von <a href="{$a->wwwroot}/user/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a> geschlossen. Falls Sie weitere Unterstützung benötigen, fordern Sie bitte wieder den 2nd Level Support an!';
...
$string['telephonefield'] = 'Telefonfeld verbergen';
$string['telephonefield:description'] = 'Telefonfeld verbergen';
