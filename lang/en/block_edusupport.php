...
$string['issue_assign_3rdlevel:post'] = '<a href="{$a->wwwroot}/profile/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a> has assigned this issue to <a href="{$a->wwwroot}/profile/view.php?id={$a->touserid}">{$a->touserfullname}</a> ({$a->tosupportlevel}).';
