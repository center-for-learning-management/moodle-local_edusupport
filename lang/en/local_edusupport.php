...
$string['issue_assign_nextlevel:post'] = '<a href="{$a->wwwroot}/user/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a> forwarded this issue to the 2nd level support';
...
$string['issue_closed:post'] = 'This issue closed was closed by <a href="{$a->wwwroot}/user/view.php?id={$a->fromuserid}">{$a->fromuserfullname}</a>. If you need further assistance please forward this issue again to the 2nd level support.';
...
$string['telephonefield'] = 'disable phonefield';
$string['telephonefield:description'] = 'disable phonefield';
...
$string['userlinks:description'] =  'userlinks:description...';
